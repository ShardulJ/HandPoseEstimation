...
class HandPoseModel(nn.Module):
    ...
    def stage_block(self,stage,padding=1):
        ...
        for n in range(2,6):
            layer.append(('Mconv{n}_stage{stage}'.format(n=n,stage=stage), nn.Conv2d(in_channels=128,out_channels=128,kernel_size=1,stride=1,padding=1)))
